--- 来源: https://github.com/Penguin-jpg/nvim-config/blob/astronvim/lua/plugins/configs/ui/heirline.lua
--- 作用: 一种heriline显示状态栏的配置
...
M.statusline = {
  ...
  -- Add a<D-b> icon to represent diagnostic and git git diff
